...
<div class="mb-8">
  <span class="mb-3 block text-xs uppercase tracking-wider text-gray-500">
    Number of surfaces
  </span>
...
<fieldset class="mb-8 space-y-3">
  <legend class="mb-3 block text-xs uppercase tracking-wider text-gray-500">
    Surface names
  </legend>
  {#each { length: surfaceCount } as _, i (i)}
    <input
      type="text"
      bind:value={names[i]}
